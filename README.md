...
## 什么是 ChatGPT 中文版？
[**ChatGPT 中文版**](https://gpt.lanjing.pro) 是由 OpenAI 的 ChatGPT 模型升级的中文版本，专为中文用户提供更流畅、更精准的 智能AI对话体验。   
...
|---------------------------------------|-----------------------|----------|----------|--------|--------------------------------------------------|
| **[chat.yixiaai.com](https://gpt.lanjing.pro)** | GPT-4, GPT-4o, o1, o3, Grok 3, Claude 3.7, DeepSeek R1 | 有       | 扫码使用 | ⭐⭐⭐⭐⭐  | 多模型、多功能，适合开发者与普通用户 |
